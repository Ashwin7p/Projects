...
public class Billing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(330, 550, 130, 23);
        ...
        jRadioButton1.setBounds(460, 420, 21, 21);

        buttonGroup1.add(jRadioButton2);
        getContentPane().add(jRadioButton2);
        jRadioButton2.setBounds(340, 420, 21, 21);
        ...
        jRadioButton3.setBounds(110, 420, 21, 21);
        ...
        jRadioButton4.setBounds(230, 420, 21, 21);
  ...
  return true;  
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        Statement statement = con.createStatement();
            ...
            statement.executeUpdate("insert into billl(payment_id,movie_id,user_id,r_cost,t_cost,total) values('"+payment_id+"','"+seat.b+"','"+u+"','"+jLabel16.getText()+"','"+jLabel15.getText()+"','"+jLabel18.getText()+"' )");
