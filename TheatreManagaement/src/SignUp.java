...
public class SignUp extends javax.swing.JFrame {
 ...
 public int seq=100;
    ...
    private void initComponents() {
        ...
        jRadioButton1.setBounds(220, 330, 59, 23);
        ...
        jRadioButton2.setBounds(310, 330, 47, 23);
        ...
        jButton1.setBounds(290, 430, 71, 23);
        ...
        jTextField3.setBounds(200, 300, 240, 20);
  ...
  return true;  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          else if(jTextField5.getText().isEmpty())
        {
         ...
         statement.executeUpdate("insert into user_login(user_id,name,password,gender,city,mob_num) values('"+seq+"','"+jTextField1.getText()+"','"+jTextField2.getText()+"','male','"+jTextField5.getText()+"','"+jTextField6.getText()+"')");   
         }
         
            
         else if(jRadioButton1.isSelected()==true)
         { statement.executeUpdate("insert into user_login(user_id,name,password,gender,city,mob_num) values('"+seq+"','"+jTextField1.getText()+"','"+jTextField2.getText()+"','female','"+jTextField5.getText()+"','"+jTextField6.getText()+"')");
                 }
         }
       //  seq++;
        // seq=seq;
